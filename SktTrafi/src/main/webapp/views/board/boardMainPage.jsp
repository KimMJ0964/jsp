	...
	<div class="wrap">
		<div class="container mt-3">
			<div class="main_image">
				<img src="/SktTrafi/views/board/img/boardMain.png"
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<li><a class="dropdown-item" href="#"
								onclick="updateDropdownText('작성자')">작성자</a></li>
							<li><a class="dropdown-item" href="#"
								onclick="updateDropdownText('제목')">제목</a></li>
							<li><a class="dropdown-item" href="#"
								onclick="updateDropdownText('작성일')">작성일</a></li>
						</ul>
					</div>
				...
				<ul class="pagination justify-content-center mt-3">
					<c:if test="${pi.currentPage ne 1}">
						<li class="page-item"><a class="page-link"
							href="board.bo?cpage=${pi.currentPage - 1}">이전</a></li>
					</c:if>

					<c:forEach var="i" begin="${pi.startPage}" end="${pi.endPage}">
						<li
							class="page-item <c:if test='${pi.currentPage eq i}'>active</c:if>">
					...
					<c:if test="${pi.currentPage ne pi.maxPage}">
						<li class="page-item"><a class="page-link"
							href="board.bo?cpage=${pi.currentPage + 1}">다음</a></li>
					</c:if>
				</ul>
			</nav>
		</div>
