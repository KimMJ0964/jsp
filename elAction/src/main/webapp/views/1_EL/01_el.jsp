...
<body>
	...
	<h3>2. EL을 이요하여 보다 쉽게 scope의 값을 출력하기</h3>
	<p>
		EL을 이용하여 getter를 통해 값을 가져올 필요 없이 EL구문내의 키값만 제시하면 바로 접근 가능 <br>
		기본적으로 EL은 JSP 내장객체를 구분하지 않고 자동으로 모든 내장객체의 키 값을 검색하여 존재하는 경우, 그 값을 가져옴
	</p>
	...
	<!-- EL은 공유범위가 가장 작은 scope부터 해당 키 값을 검색함(page -> request -> session -> application) -->
	test값: ${test}
