...
<body>
	...
	<p>
		...
		(fmt:foramtNumber value="출력할값" [groupingUsed="true | false" type="percent | currency" currencySymbol="문자"])
	</p>
	...
	<ul>
		<li>현재 날짜 : <fmt:formatDate value="${current }" type="date" /></li><!-- type 생략시 type="date" -->
