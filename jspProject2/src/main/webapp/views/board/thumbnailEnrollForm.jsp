                    ...
                    if(_input.files.length == 1) {  // 파일이 하나 선택됬다.
                        ...
                        reader.onload = function(ev) {
                            ...
                            switch(num) {
                                ...
                                case 3: $("#content-img2").sttr("src", ev.target.result); break;
                                case 4: $("#content-img3").sttr("src", ev.target.result); break;
                            }
                        }
                    } else {    // 선택된 파일을 최소한 경우 -> 미리보기를 지워준다.
                        switch(num) {
                                case 1: document.getElementById("title-img").src = null; break;
                                case 2: document.querySelector("#content-img1").src = null; break;
                                case 3: $("#content-img2").sttr("src", null); break;
                                case 4: $("#content-img3").sttr("src", null); break;
                            }
                    }
                }
